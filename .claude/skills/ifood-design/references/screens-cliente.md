...
- **A coluna mede `w-11`** (44px, a largura do próprio "+") e existe em toda linha, com ou sem foto, em todos os estados. É por isso que o stepper dela é `orientation="vertical"`: deitado ele mediria 90px e, nas linhas já na sacola, empurraria a foto uns 46px para a esquerda — a lista sai da régua. Reservar a largura do stepper deitado também alinha, mas abre um vão morto entre a foto e o "+" em toda linha que não está na sacola.
