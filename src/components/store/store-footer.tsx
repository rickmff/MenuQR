    ...
    <footer className="mt-16 border-t border-cream-200 bg-white">
      <div className="container-page grid gap-10 py-14 md:grid-cols-2 lg:grid-cols-3">
        <div>
          ...
          {hasAddress && (
            <address className="mt-4 space-y-1 text-sm not-italic text-charcoal-500">
          ...
          <ul className="mt-4 space-y-1 text-sm text-charcoal-500">
            {business.whatsapp && (
              <li>
                <a className="hover:text-charcoal-900" href={`tel:${toE164(business.whatsapp)}`}>
            ...
            {business.email && (
              <li>
                <a className="hover:text-charcoal-900" href={`mailto:${business.email}`}>
                  {business.email}
                </a>
              </li>
            )}
      ...
      <div className="border-t border-cream-200">
        <div className="container-page flex flex-col gap-2 py-6 text-xs text-charcoal-500 sm:flex-row sm:items-center sm:justify-between">
          <p>
            © {currentYear} {business.name}
          </p>
          <p>
            Cardápio digital por{' '}
            <Link href="/" className="font-semibold hover:text-charcoal-900">
              {platform.name}
            </Link>{' '}
            ·{' '}
